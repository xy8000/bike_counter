...
const STATIONS: &[(&str, &str, f64, f64)] = &[
    ...
    ("300037926", "Bohlweg", 51.9687, 7.6437),
    ("300039328", "Coesfelder Kreuz", 51.9660, 7.6012),
    ("100034978", "Gartenstraße", 51.9715, 7.6356),
    ("300037931", "Gasselstiege", 51.9796, 7.6065),
    ("300037925", "Goldstraße", 51.9682, 7.6380),
    ("300039331", "Grevener Straße", 51.9750, 7.6117),
    ("100031300", "Hafenstraße", 51.9550, 7.6325),
    ...
    ("300037928", "Kinderhauser Str.", 51.9788, 7.6208),
    ("300037920", "Lütkenbecker Weg", 51.9430, 7.6485),
    ("100035541", "Neutor", 51.9670, 7.6154),
    ("100031297", "Promenade (nördlich Salzstraße)", 51.9606, 7.6340),
    ("300037405", "Promenade (westlicher Hals)", 51.9589, 7.6195),
    ("300037932", "Schmeddingstraße", 51.9595, 7.5905),
