...
const STATIONS: &[(&str, &str, f64, f64)] = &[
    ...
    ("300039331", "Grevener Straße", 51.9795, 7.6120),
    ("100031300", "Hafenstraße", 51.9549, 7.6289),
    ("100034980", "Hammer Straße", 51.9545, 7.6263),
    ("100034982", "Hüfferstraße", 51.9619, 7.6109),
    ("300037544", "Kanalpromenade Abschnitt 1 (Dingstiege)", 51.9900, 7.6410),
    ("100053305", "Kanalpromenade Abschnitt 5", 51.9181, 7.6497),
    ("300037936", "Kanalpromenade Abschnitt 6", 51.8903, 7.6568),
    ("300037928", "Kinderhauser Str.", 51.9803, 7.6135),
