#!/usr/bin/env bash
# Generates scripts/e2e-seed.sql — a small, committed SQL fixture for the
...
# via docker-compose.e2e.yml), making the run fully offline w.r.t. the providers.
#
...
OUT="${PROJECT_ROOT}/scripts/e2e-seed.sql"
...

{
  ...
  echo "-- scripts/e2e-playwright.sh + docker-compose.e2e.yml."
